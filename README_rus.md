...
Открытая **enterprise-платформа Identity Governance & Administration**, разработанная для крупных агрохолдингов.  
Обеспечивает полный жизненный цикл управления учётными записями и доступами к 27 корпоративным системам в полном соответствии с лучшими практиками и требованиями регуляторов.
...
| Self-Service портал     | Desktop + Mobile PWA (React 18 + Material-UI)                                                  |
...
| 4 | Самообслуживание сотрудников                  | Сотрудник сам запрашивает временный доступ, сбрасывает пароль, видит свои роли и историю            | Снижение нагрузки на ИТ и ИБ в 5–10 раз        |
...
Эти возможности могут быть подключены как дополнительные модули.
