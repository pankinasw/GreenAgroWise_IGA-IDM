...
Корпоративная система класса **Identity Governance & Administration (IGA)** с открытым исходным кодом, предназначенная для централизованного управления идентификацией и доступами в крупных агрохолдингах и распределённых производственных структурах.

Платформа поддерживает **полный жизненный цикл учётных записей и прав доступа (Joiner–Mover–Leaver)**, автоматизирует процессы согласования, ресертификации и аудита доступов, а также управляет интеграциями с **27 корпоративными и государственными системами**.
...
Решение готово к эксплуатации в среде с повышенными требованиями к контролю доступов, **разделению обязанностей (SoD)**, **трассируемости действий** и подготовке к регуляторным проверкам.
...
|--------------------------------------------|----------------------------------------------------------------------|---------------------------------------------------------|
| **Техническое задание**                    | Полные требования, функциональные и нефункциональные спецификации    | [Техническое задание](./docs/technical-specification.pdf) |
| **Руководство пользователя**               | Пошаговые инструкции для сотрудников и согласующих                  | [`Руководство_пользователя`](./docs/user-guide.pdf) |
| **Руководство администратора**             | Развёртывание, настройка, сопровождение                              | [`Руководство администратора`](./docs/admin-guide.pdf) |
| **Обзор архитектуры**                      | Высокоуровневые и детальные схемы (исходник Draw.io)                  | [`docs/architecture.drawio`](./docs/architecture.drawio) |
| **Модель угроз (STRIDE + DREAD)**          | Анализ безопасности и матрица рисков                                 | [`Модель угроз (STRIDE + DREAD)`](./docs/threat-model-stride.pdf) |
